...
public class MySQLCaseOperatorTest {
    ...
    void getExpectedValue_switchConditionMatchesWhen_ReturnsThen() {
        ...
        assertEquals("11", caseOperator.getExpectedValue().toString());
    }
    ...
    void getExpectedValue_switchConditionHasNoMatches_ReturnsElse() {
        ...
        assertEquals("0",
                new MySQLCaseOperator(switchExpr, whenExprs, thenExprs, elseExpr).getExpectedValue().toString());
        assertEquals("NULL",
                new MySQLCaseOperator(switchExpr, whenExprs, thenExprs, null).getExpectedValue().toString());
    }
    ...
    void getExpectedValue_whenAllFalse_ReturnsElse() {
        ...
        assertEquals("0", new MySQLCaseOperator(null, whenExprs, thenExprs, elseExpr).getExpectedValue().toString());
        assertEquals("NULL", new MySQLCaseOperator(null, whenExprs, thenExprs, null).getExpectedValue().toString());
    }
}
