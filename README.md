...
|------------------------------|-------------|------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [SQLite](https://github.com/sqlite/sqlite)                       | Working     | Untyped                      | This implementation is currently affected by a significant performance regression that still needs to be investigated                                                                           |
| [MySQL](https://github.com/mysql/mysql-server)                        | Working     | Untyped                      | Running this implementation likely uncovers additional, unreported bugs.                                                                                                                        |
| PostgreSQL                   | Working     | Typed                        |                                                                                                                                                                                                 |
| [Citus (PostgreSQL Extension)](https://github.com/citusdata/citus) | Working | Typed                        | This implementation extends the PostgreSQL implementation of SQLancer, and was contributed by the Citus team.                                                                                   |
...
| [CockroachDB](https://github.com/cockroachdb/cockroach)                  | Working     | Typed                        |                                                                                                                                                                                                 |
| [TiDB](https://github.com/pingcap/tidb)                         | Working     | Untyped                      |                                                                                                                                                                                                 |
| [DuckDB](https://github.com/duckdb/duckdb)                       | Working     | Untyped, Generic             |                                                                                                                                                                                                 |
| [ClickHouse](https://github.com/ClickHouse/ClickHouse)                   | Preliminary | Untyped, Generic             | Implementing the different table engines was not convenient, which is why only a very preliminary implementation exists.                                                                        |
| [TDEngine](https://github.com/taosdata/TDengine)                     | Removed     | Untyped                      | We removed the TDEngine implementation since all but one of our bug reports were still unaddressed five months after we reported them.                                                          |
| [OceanBase](https://github.com/oceanbase/oceanbase)                    | Working     | Untyped                      |                                                                                                                                                                                                 |
| [YugabyteDB](https://github.com/yugabyte/yugabyte-db)                   | Working     | Typed (YSQL), Untyped (YCQL) | YSQL implementation based on Postgres code. YCQL implementation is primitive for now and uses Cassandra JDBC driver as a proxy interface.                                                       |
| [Databend](https://github.com/datafuselabs/databend)                     | Working     | Typed                      |  |
| [QuestDB](https://github.com/questdb/questdb)                      | Working     | Untyped, Generic                      | The implementation of QuestDB is still WIP, current version covers very basic data types, operations and SQL keywords. |
| [CnosDB](https://github.com/cnosdb/cnosdb)                       |Working      | Typed                        | The implementation of CnosDB currently uses Restful API.                                                                                                                                        |
| [Materialize](https://github.com/Dogfalo/materialize)                  |Working      | Typed                        |
| [Apache Doris](https://github.com/apache/doris)                 | Preliminary | Typed                   | This is a preliminary implementation, which only contains the common logic of Doris. We have found some errors through it, and hope to improve it in the future.
| [Presto](https://github.com/prestodb/presto)                       | Preliminary | Typed                   | This is a preliminary implementation, only basic types supported. 
