...
public class SQLite3CollateHelper {
	...
	public static boolean shouldGetSubexpressionAffinity(SQLite3Expression expression) {
		return (expression instanceof SQLite3UnaryOperation && ((SQLite3UnaryOperation) expression).getOperation() == UnaryOperator.PLUS) || expression instanceof Cast || expression instanceof ColumnName;
	}
