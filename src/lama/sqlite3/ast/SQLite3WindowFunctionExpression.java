...
public class SQLite3WindowFunctionExpression extends SQLite3Expression {
	...
	public static class SQLite3WindowFunctionFrameSpecTerm extends SQLite3Expression {
		...
		public static enum SQLite3WindowFunctionFrameSpecTermKind {
			UNBOUNDED_PRECEDING("UNBOUNCDED PRECEDING"), EXPR_PRECEDING("PRECEDING"), CURRENT_ROW("CURRENT ROW"), EXPR_FOLLOWING("FOLLOWING"), UNBOUNDED_FOLLOWING("UNBOUNDED FOLLOWING");
