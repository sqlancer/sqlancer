...
import lama.postgres.ast.PostgresConstant.PostgresNullConstant;

public class PostgresComputableFunction extends PostgresExpression {

	private final PostgresFunction func;
	private final PostgresExpression[] args;
	private final PostgresDataType returnType;

	public PostgresComputableFunction(PostgresFunction func, PostgresDataType returnType, PostgresExpression... args) {
		this.func = func;
		this.returnType = returnType;
		this.args = args;
	}

	public PostgresFunction getFunction() {
		return func;
	}
...
//		},;
		...
		private PostgresFunction(int nrArgs, String functionName) {
			this.nrArgs = nrArgs;
			this.functionName = functionName;
			this.variadic = false;
		}

		private PostgresFunction(int nrArgs, String functionName, boolean variadic) {
			this.nrArgs = nrArgs;
			this.functionName = functionName;
		...
		public static PostgresFunction getRandomFunction() {
