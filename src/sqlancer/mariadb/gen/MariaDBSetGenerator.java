...
public class MariaDBSetGenerator {
    ...
    private enum Action {
        ...
        CONCURRENT_INSERT("concurrent_insert", (r) -> Randomly.fromOptions("NEVER", "AUTO", "ALWAYS", 0, 1, 2),
                Scope.GLOBAL), CTE_MAX_RECURSION_DEPTH("cte_max_recursion_depth", (r) -> r.getLong(0, 4294967295L),
                        Scope.GLOBAL), DELAY_KEY_WRITE("delay_key_write",
                                ...
                                Scope.GLOBAL), EQ_RANGE_INDEX_DIVE_LIMIT("eq_range_index_dive_limit",
                                        (r) -> r.getLong(0, 4294967295L), Scope.GLOBAL), FLUSH("flush",
                                                ...
                                                Scope.GLOBAL), FOREIGN_KEY_CHECKS("foreign_key_checks",
                                                        ...
                                                        Scope.SESSION), HOST_CACHE_SIZE("host_cache_size",
                                                                (r) -> r.getLong(0, 65536),
                                                                Scope.GLOBAL), JOIN_BUFFER_SIZE("join_buffer_size",
                                                                        (r) -> r.getLong(128, Long.MAX_VALUE),
        ...
        // Scope.SESSION),
        MAX_LENGTH_FOR_SORT_DATA("max_length_for_sort_data", (r) -> r.getLong(4, 8388608), Scope.GLOBAL,
                Scope.SESSION), MAX_SEEKS_FOR_KEY("max_seeks_for_key", (r) -> r.getLong(1, Long.MAX_VALUE),
                        Scope.GLOBAL, Scope.SESSION), MAX_SORT_LENGTH("max_sort_length", (r) -> r.getLong(4, 8388608),
                                Scope.GLOBAL, Scope.SESSION), MAX_SP_RECURSION_DEPTH("max_sp_recursion_depth",
                                        (r) -> r.getLong(0, 255), Scope.GLOBAL,
                                        Scope.SESSION), MYISAM_DATA_POINTER_SIZE("myisam_data_pointer_size",
                                                (r) -> r.getLong(2, 7),
                                                Scope.GLOBAL), MYISAM_MAX_SORT_FILE_SIZE("myisam_max_sort_file_size",
                                                        (r) -> r.getLong(0, 9223372036854775807L),
                                                        Scope.GLOBAL), MYISAM_REPAIR_THREADS("myisam_repair_threads",
                                                                (r) -> r.getLong(1, Long.MAX_VALUE), Scope.GLOBAL,
                                                                Scope.SESSION),
        ...
        MYISAM_STATS_METHOD("myisam_stats_method",
                ...
                Scope.SESSION), MYISAM_USE_MMAP("myisam_use_mmap", (r) -> Randomly.fromOptions("OFF", "ON"),
                        Scope.GLOBAL), OPTIMIZER_PRUNE_LEVEL("optimizer_prune_level", (r) -> Randomly.fromOptions(0, 1),
                                Scope.GLOBAL, Scope.SESSION), OPTIMIZER_SEARCH_DEPTH("optimizer_search_depth",
                                        (r) -> r.getLong(0, 62), Scope.GLOBAL,
                                        Scope.SESSION), OPTIMIZER_SWITCH("optimizer_switch",
                                                (r) -> getOptimizerSwitchConfiguration(r), Scope.GLOBAL, Scope.SESSION),
