package sqlancer.h2.dialect;

import java.util.List;

import sqlancer.h2.dialect.expression.H2Function;
import sqlancer.h2.dialect.expression.H2IsDistinctFrom;
import sqlancer.h2.dialect.expression.H2IsFalse;
import sqlancer.h2.dialect.expression.H2IsTrue;
...
public class H2Dialect implements Dialect {
    static List<Type> legalTypes = List.of(new BigInt(), new Boolean(), new Double(), new Varchar());
    static List<Class<? extends Expression>> legalExpressions = List.of(Between.class, BinaryArithmetic.class,
            BinaryComparison.class, BinaryLogical.class, Case.class, Cast.class, ColumnName.class, Constant.class,
            In.class, IsNull.class, Like.class, Not.class, PrefixSign.class, H2Function.class, H2IsDistinctFrom.class,
            H2IsFalse.class, H2IsTrue.class);
