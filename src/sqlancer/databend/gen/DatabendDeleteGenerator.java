...
public class DatabendDeleteGenerator {
    ...
    public DatabendDeleteGenerator() {
    }
    ...
    public static SQLQueryAdapter generate(DatabendGlobalState globalState){
        ...
        if(Randomly.getBoolean()) {
            sb.append(" WHERE ");
            sb.append(DatabendToStringVisitor.asString(new DatabendNewExpressionGenerator(globalState)
                    .generateExpression(DatabendDataType.BOOLEAN)));
