...
@Parameters(separators = "=", commandDescription = "PostgreSQL (default port: " + MaterializeOptions.DEFAULT_PORT
        + ", default host: " + MaterializeOptions.DEFAULT_HOST + ")")
public class MaterializeOptions implements DBMSSpecificOptions<MaterializeOracleFactory> {
    ...
    public String connectionURL = String.format("postgresql://%s:%d/test", MaterializeOptions.DEFAULT_HOST,
            MaterializeOptions.DEFAULT_PORT);
