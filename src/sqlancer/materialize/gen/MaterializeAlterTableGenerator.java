...
public class MaterializeAlterTableGenerator {

    private MaterializeTable randomTable;
    private Randomly r;
    private static MaterializeColumn randomColumn;
    @SuppressWarnings("unused") private boolean generateOnlyKnown;
    @SuppressWarnings("unused") private List<String> opClasses;
    ...
    public MaterializeAlterTableGenerator(MaterializeTable randomTable, MaterializeGlobalState globalState,
    ...
    public static SQLQueryAdapter create(MaterializeTable randomTable, MaterializeGlobalState globalState,
            boolean generateOnlyKnown) {
        return new MaterializeAlterTableGenerator(randomTable, globalState, generateOnlyKnown).generate();
    }

    @SuppressWarnings("unused") private enum Attribute {
    ...
    public SQLQueryAdapter generate() {
        ...
        for (Action a : action) {
            ...
            //    }
            //    sb.append(" TYPE ");
            //    MaterializeDataType randomType = MaterializeDataType.getRandomType();
            //    MaterializeCommon.appendDataType(randomType, sb, false, generateOnlyKnown, opClasses);
            ...
            //                MaterializeExpressionGenerator.generateExpression(globalState, randomColumn.getType())));
            ...
            case ADD_TABLE_CONSTRAINT:
                ...
                MaterializeCommon.addTableConstraint(sb, randomTable, globalState, errors);
    ...
    @SuppressWarnings("unused") private static void alterColumn(MaterializeTable randomTable, StringBuilder sb) {
        sb.append("ALTER ");
