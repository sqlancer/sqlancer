...
public class MaterializeTableGenerator {
    ...
    @SuppressWarnings("unused") private boolean isTemporaryTable;
    private boolean isPartitionedTable;
    @SuppressWarnings("unused") private final MaterializeSchema newSchema;
    ...
    private void generatePartitionBy() {
        ...
        //    }
        //    sb.append("(");
        //    MaterializeExpression expr = MaterializeExpressionGenerator.generateExpression(globalState, columnsToBeAdded);
    ...
    private void createColumnConstraint(MaterializeDataType type, boolean serial) {
        ...
        for (ColumnConstraint c : constraintSubset) {
            ...
            case DEFAULT:
                ...
                sb.append("DEFAULT");
                sb.append(" (");
                sb.append(MaterializeVisitor.asString(MaterializeExpressionGenerator.generateExpression(globalState, type)));
                sb.append(")");
