...
public final class MaterializeVacuumGenerator {

    private MaterializeVacuumGenerator() {
    }
    ...
    private static void addTableAndColumns(MaterializeTable table, StringBuilder sb) {
        sb.append(" ");
        sb.append(table.getName());
        if (Randomly.getBoolean()) {
            sb.append("(");
