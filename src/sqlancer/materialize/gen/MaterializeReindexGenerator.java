...
public final class MaterializeReindexGenerator {

    private MaterializeReindexGenerator() {
    }
    ...
    public static SQLQueryAdapter create(MaterializeGlobalState globalState) {
        ...
        case INDEX:
            ...
            List<MaterializeIndex> indexes = globalState.getSchema().getRandomTable().getIndexes();
            if (indexes.isEmpty()) {
