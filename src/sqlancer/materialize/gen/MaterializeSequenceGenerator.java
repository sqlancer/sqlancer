...
public final class MaterializeSequenceGenerator {

    private MaterializeSequenceGenerator() {
    }

    public static SQLQueryAdapter createSequence(MaterializeGlobalState globalState) {
