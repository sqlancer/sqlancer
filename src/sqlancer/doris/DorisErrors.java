...
public final class DorisErrors {
    ...
    public static void addExpressionErrors(ExpectedErrors errors) {
        errors.add("The olap table first column could not be float, double, string or array, please use decimal or varchar instead.");
        errors.add("Create unique keys table should not contain random distribution desc");
        errors.add("Number out of range");
        errors.add("Invalid precision and scale");
