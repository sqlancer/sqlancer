...
//        ARRAY_FILTER(2),      // use lambda expression, currently not considered
        ...
        ARRAY_WITH_CONSTANT(2),
        ARRAY_ENUMERATE(1),
        ARRAY_ENUMERATE_UNIQ(1),
        ARRAY_POPBACK(1),
        ARRAY_POPFRONT(1),
        ARRAY_PUSHFRONT(2),
        ARRAY_COMPACT(1),
        ...
        APPEND_TRAILING_CHAR_IF_ABSENT(2),
        ENDS_WITH(2),
        STARTS_WITH(2),
        TRIM(0) {
            @Override
        ...
        BITMAP_NOT(2),
        BITMAP_AND_NOT(2),
        BITMAP_SUBSET_LIMIT(3),
        BITMAP_SUBSET_IN_RANGE(3),
        SUB_BITMAP(3),
        BITMAP_COUNT(1),
        BITMAP_AND_COUNT(2, true),
        BITMAP_AND_NOT_COUNT(2),
        ORTHOGONAL_BITMAP_UNION_COUNT(2, true),
        BITMAP_XOR_COUNT(2, true),
        BITMAP_OR_COUNT(2, true),
        BITMAP_CONTAINS(2),
        BITMAP_HAS_ALL(2),
        BITMAP_HAS_ANY(2),
        BITMAP_MAX(1),
        BITMAP_MIN(1),
        INTERSECT_COUNT(2, true),
        BITMAP_INTERSECT(1),
        ORTHOGONAL_BITMAP_INTERSECT(3),
        ORTHOGONAL_BITMAP_INTERSECT_COUNT(3),
        ORTHOGONAL_BITMAP_EXPR_CALCULATE(3),
        ORTHOGONAL_BITMAP_EXPR_CALCULATE_COUNT(3),
        BITMAP_HASH64(1),
...
//        case(),
        ...
        JSONB_PARSE(1),
        JSONB_PARSE_ERROR_TO_NULL(1),
        JSONB_PARSE_ERROR_TO_VALUE(2),
        JSONB_EXTRACT(2),
        JSONB_EXTRACT_ISNULL(2),
        JSONB_EXTRACT_BOOL(2),
        JSONB_EXTRACT_INT(2),
        JSONB_EXTRACT_BIGINT(2),
        JSONB_EXTRACT_DOUBLE(2),
        JSONB_EXTRACT_STRING(2),
        JSONB_EXISTS_PATH(2),
        JSONB_TYPE(2),
        GET_JSON_DOUBLE(2),
        GET_JSON_INT(2),
        ...
        // Hash functions, https://doris.apache.org/zh-CN/docs/dev/sql-manual/sql-functions/hash-functions/murmur_hash3_32
        MURMUR_HASH3_32(0, true),
        MURMUR_HASH3_64(0, true),
        ...
        // /encrypt-digest-functions, https://doris.apache.org/zh-CN/docs/dev/sql-manual/sql-functions/encrypt-digest-functions/aes
