...
public final class TiDBSetGenerator {
    ...
    private enum Action {
        ...
        TIDB_OPT_AGG_PUSH_DOWN("tidb_opt_agg_push_down",
                (r) -> Randomly.fromOptions(0, 1)), TIDB_BUILD_STATS_CONCURRENCY("tidb_build_stats_concurrency",
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                100)), TIDB_INDEX_JOIN_BATCH_SIZE(
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        (r) -> Randomly
                                                                                                                                                                                                                                .getNotCachedInteger(
                                                                                                                                                                                                                                        1,
                                                                                                                                                                                                                                        5000)), //
        TIDB_INDEX_SKIP_UTF8_CHECK("tidb_skip_utf8_check", (r) -> Randomly.fromOptions(0, 1)), TIDB_INIT_CHUNK_SIZE(
                "tidb_init_chunk_size",
                (r) -> Randomly.getNotCachedInteger(1, 32)), TIDB_MAX_CHUNK_SIZE("tidb_max_chunk_size",
        ...
        TIDB_ENABLE_FAST_ANALYZE("tidb_enable_fast_analyze",
                (r) -> Randomly.fromOptions(0, 1)), TIDB_WAIT_SPLIT_REGION_FINISH("tidb_wait_split_region_finish",
                        (r) -> Randomly.fromOptions(0, 1)),
        // TODO: global
        // TIDB_SCATTER_REGION("tidb_scatter_region", (r) -> Randomly.fromOptions(0, 1));
        TIDB_ENABLE_STMT_SUMMARY("tidb_enable_stmt_summary", (r) -> Randomly.fromOptions(0, 1)), TIDB_ENABLE_CHUNK_RPC(
                "tidb_enable_chunk_rpc", (r) -> Randomly.fromOptions(0, 1));
