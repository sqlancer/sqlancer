...
public class TiDBFunctionCall implements TiDBExpression {
	...
	public enum TiDBFunction {
		...
		POW(2), POWER(2), EXP(1), SQRT(1), LN(1), LOG(1), LOG2(1), LOG10(1), PI(0), TAN(1), COT(1), SIN(1), COS(1),
		ATAN(1), ATAN2(2), ACOS(1), RADIANS(1), DEGREES(1), MOD(2), ABS(1), CEIL(1), CEILING(1), FLOOR(1), ROUND(1),
//		RAND(1),
		SIGN(1),
//		CONV()
		// TRUNCATE(),
...
//		ROW_COUNT(0),  <-- non-deterministic
		...
		// string functions
		ASCII(1), BIN(1), BIT_LENGTH(1), CHAR(1), CHAR_LENGTH(1), CHARACTER_LENGTH(1), CONCAT(1, true),
		CONCAT_WS(2, true), ELT(2, true), EXPORT_SET(0) {
			@Override
		...
		RTRIM(1),
		// SPACE(1),
		// https://github.com/tidb-challenge-program/bug-hunting-issue/issues/6
		...
		INET_ATON(1), INET_NTOA(1), INET6_ATON(1), INET6_NTOA(1), IS_IPV4(1), IS_IPV4_COMPAT(1), IS_IPV4_MAPPED(1),
		IS_IPV6(1),
//		NAME_CONST(2),
