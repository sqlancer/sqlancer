...
public final class YSQLTruncateGenerator {
    ...
    public static SQLQueryAdapter create(YSQLGlobalState globalState) {
        ...
        return new SQLQueryAdapter(sb.toString(), ExpectedErrors
                .from("cannot truncate a table referenced in a foreign key constraint", "is not a table", "Failed DDL operation as requested", "could not serialize access due to concurrent update"));
    }
