...
public class PostgresSimilarTo extends PostgresExpression {
	...
	public PostgresSimilarTo(PostgresExpression string, PostgresExpression similarTo, PostgresExpression escapeCharacter) {
		this.string = string;
