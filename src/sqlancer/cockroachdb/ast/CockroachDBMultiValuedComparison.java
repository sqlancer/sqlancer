...
public class CockroachDBMultiValuedComparison extends CockroachDBExpression {
	...
	public CockroachDBMultiValuedComparison(CockroachDBExpression left, List<CockroachDBExpression> right, MultiValuedComparisonType type, MultiValuedComparisonOperator op) {
		this.left = left;
		this.right = right;
		this.type = type;
		this.op = op;
