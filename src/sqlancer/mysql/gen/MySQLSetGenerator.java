...
//		KEY_CACHE_DIVISION_LIMIT("key_cache_division_limit", (r) -> r.getLong(1, 100), Scope.GLOBAL),
		...
		RANGE_OPTIMIZER_MAX_MEM_SIZE("range_optimizer_max_mem_size", (r) -> r.getLong(0, Long.MAX_VALUE), Scope.GLOBAL,
				Scope.SESSION),
		/*
		 * Removed Scope.GLOBAL as a workaround for
		 * https://bugs.mysql.com/bug.php?id=95985
		 */
		RBR_EXEC_MODE("rbr_exec_mode", (r) -> Randomly.fromOptions("IDEMPOTENT", "STRICT"), Scope.SESSION),
		...
		/*
		 * sort_buffer_size is commented out as a workaround for
		 * https://bugs.mysql.com/bug.php?id=95969
		 */
